...
<?php echo $this->Form->create('Medic');?>
	<fieldset>
		<legend><?php echo __('Edit Medic'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Medic.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Medic.id'))); ?></li>
