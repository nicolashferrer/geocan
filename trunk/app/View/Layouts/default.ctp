	...
	?>
		<script type="text/javascript">
			...
			$(document).ready(function() {
				...
				//echo $this->Html->link(utf8_encode('Volver a la ficha del último paciente consultado'),array('controller' => 'patients', 'action' => 'view', $this->Session->read('PacienteActual')));	
				?>
