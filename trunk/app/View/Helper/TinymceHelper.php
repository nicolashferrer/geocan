    ...
    private function preset($name){ 
        ...
        if($name == 'basic'){ 
            return array( 
                ...
                'theme_advanced_buttons1' => 'forecolor,|,fontsizeselect,|,justifyleft,justifycenter,justifyright,|,copy,pastetext,|,bold,italic,underline,|,removeformat,cleanup,|,bullist,numlist,|',
