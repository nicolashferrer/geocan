...
function buscar(tipoDireccion) {
	...
	if ((calle != "" && altura !="") && (isNaN(altura)==false)) {
		...
		jAlert("Debe ingresar una direcci&oacute;n correcta.","Errores de GeolocalizaciÃ³n");
	}
}
	...
	//		" <a href=http://maps.google.com/maps?t=m&q="+lat+","+ lng+" target='_blank'>Comprobar Coordenadas!</a>");
			...
			jAlert("Direcci&oacute;n encontrada.","Errores de GeolocalizaciÃ³n");
			...
			jAlert("No se pudo geolocalizar la direcci&oacute;n encontrada.","Errores de GeolocalizaciÃ³n");
		}
	}