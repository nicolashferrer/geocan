				...
				<?php
					...
					<tr>
						...
						<td class="actions">
							...
							<?php echo $this->Form->postLink(__('Borrar'), array('controller' => 'oms_registers', 'action' => 'delete', $omsRegister['id'],$patient['Patient']['id']), null, __('Esta usted seguro que desea eliminar # %s?', $omsRegister['id'])); ?>
						</td>
					</tr>
					<?php endforeach; ?>
				</table>
